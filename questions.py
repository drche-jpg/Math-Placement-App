...
all_questions = [
    ...
    {"id": 209, "difficulty": "Level 2: Intermediate", "category": "Number Sense & Operations", "question": r"Express 0.00045 in proper scientific notation.", "options": [r"$4.5\times10^{-4}$", r"$4.5\times10^{-5}$", r"$45\times10^{-5}$", "0.45"], "answer": "$4.5 \times 10^{-4}$", "solution": r"Move the decimal 4 places to the right."},
