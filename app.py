...
if st.session_state.page == "setup":
    ...
    st.markdown("### National Talent Search & Diagnostic Assessment")
    ...
    with col2:
        ...
        # --- Professional 100-word feedback ---
        if perc >= 85:
            feedback = f"Excellent demonstration of mathematical mastery by {st.session_state.student_name}. The candidate displays high fluency in complex problem-solving and logical deduction. The results suggest a readiness for advanced competitive training or accelerated curriculum."
        elif perc >= 60:
